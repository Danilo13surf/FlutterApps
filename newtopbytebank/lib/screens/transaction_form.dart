...
import 'package:newtopbytebank/components/centered_message.dart';
...
import 'package:newtopbytebank/components/response_dialog.dart';
import 'package:newtopbytebank/components/transaction_auth_dialog.dart';
import 'package:newtopbytebank/http/webcliente/transaction_webclient.dart';
...
class TransactionFormCubit extends Cubit<TransactionFormState> {
  ...
  void save(Transactions transactionCreated, String password,
  ...
  _send(Transactions transactionCreated, String password,
      BuildContext context) async {
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      final transactionCreated = Transactions(transactionId,
                          value, _contact, _contact.email, _contact.avatarUrl);
                      final double limit = 0;
                      // assert(value > limit);
                      final balance =
                          Provider.of<Balance>(context, listen: false);
                      // if (balance.valueB < limit) {}
                      if (balance.valueB > limit) {
                        showDialog(
                          context: context,
